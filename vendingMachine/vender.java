        ...
        switch(drinkChoice){
            ...
            if(userinput==1){
                ...
                int quantityChoice = input.nextInt();
                    ...
                    if(quantityChoice==0){
                    System.out.println("-> You have choose : "+quantity[quantityChoice]+" -> "+water[quantityChoice]+" Rs");
            ...
            if(userinput1==1){
                ...
                int quantityChoice = input.nextInt();
                    ...
                    if(quantityChoice==0){
                    System.out.println("-> You have choose : "+quantity[quantityChoice]+" -> "+vodka[quantityChoice]+" Rs");
            ...
            if(userinput2==1){
                ...
                int quantityChoice = input.nextInt();
                    ...
                    if(quantityChoice==0){
                    System.out.println("-> You have choose : "+quantity[quantityChoice]+" -> "+corona_extra[quantityChoice]+" Rs");
            ...
            if(userinput3==1){
                ...
                int quantityChoice = input.nextInt();
                    ...
                    if(quantityChoice==0){
                    System.out.println("-> You have choose : "+quantity[quantityChoice]+" -> "+mango_juice[quantityChoice]+" Rs");
            ...
            if(userinput4==1){
                ...
                int quantityChoice = input.nextInt();
                    ...
                    if(quantityChoice==0){
                    System.out.println("-> You have choose : "+quantity[quantityChoice]+" -> "+coco_cola[quantityChoice]+" Rs");
